...
# NETWORK_VOLUME_PATH constant y _OUTPUT_DIR_CANDIDATES NV entry removidos
# 2026-04-15 — parte del cleanup sistémico post-migración (ver rules/runpod-infrastructure.md).
